                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($enters as $enter) : ?>
                                        <tr>
                                            ...
                                            <td><a href="edit_status.php?id_matkul=<?= $enter["id_matkul"]; ?>&id_peserta=<?= $enter["id_peserta"]; ?>&id_akun=<?= $id_akun; ?>"><span class="glyphicon glyphicon-edit" title="Edit Status"></span> Edit Status</a></td>
                                        </tr>
                                        <?php $no++; ?>
                                    <?php endforeach; ?>
                                </tbody>
