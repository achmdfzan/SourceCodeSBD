...
$nama_dosen = tampil("SELECT nama_dosen FROM dosen WHERE id_dosen=$id_dosen")[0];
...
FROM program_mbkm
    JOIN (
        ...
        FROM peserta_program_mbkm
            ...
            WHERE id_pembimbing_mbkm = $id_dosen
    ) as X ON program_mbkm.id_program_mbkm = X.id_program_mbkm
    JOIN kategori_program ON program_mbkm.id_kategori_program = kategori_program.id_kategori_program GROUP BY X.nim;");
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Daftar Mahasiswa Program <b><?= $nama_dosen['nama_dosen'] ?></b></h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    foreach ($enters as $enter) : ?>
                                        <tr>
                                            ...
                                            <td><a href="ubah.php?id=<?= $enter["id_program_mbkm"]; ?>"><span class="glyphicon glyphicon-edit" title="Edit Data"></span></a> | <a href="hapus.php?id=<?= $enter["id_program_mbkm"]; ?>"><span class="glyphicon glyphicon-remove" title="Hapus Data" onclick="return confirm('Yakin?')"></span></a> | <a href="detail-mahasiswa.php?id_peserta_mbkm=<?= $enter["id_peserta_mbkm"]; ?>"><span class="glyphicon glyphicon-info-sign" title="Detail Mahasiswa"></span><span> Detail Mahasiswa</span></a></td>
                                        </tr>
                                    <?php endforeach;
                                    ?>
                                </tbody>
