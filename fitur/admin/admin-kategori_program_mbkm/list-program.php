...
WHERE program_mbkm.id_kategori_program = $id_kategori_program GROUP BY program_mbkm.kd_program;");
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Daftar Mahasiswa <?= $kategori_program['nama_kategori'] ?></h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    foreach ($enters as $enter) : ?>
                                        <tr>
                                            ...
                                            <td><a href="ubah.php?id=<?= $enter["id_program_mbkm"]; ?>"><span class="glyphicon glyphicon-edit" title="Edit Data"></span></a> | <a href="hapus.php?id=<?= $enter["id_program_mbkm"]; ?>"><span class="glyphicon glyphicon-remove" title="Hapus Data" onclick="return confirm('Yakin?')"></span></a> | <a href="detail-program.php?id_program_mbkm=<?= $enter["id_program_mbkm"]; ?>"><span class="glyphicon glyphicon-info-sign" title="Detail Mahasiswa"></span><span> Daftar Mahasiswa</span></a></td>
                                        </tr>
                                    <?php endforeach;
                                    ?>
                                </tbody>
