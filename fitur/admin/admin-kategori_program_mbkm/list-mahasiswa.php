...
WHERE program_mbkm.id_kategori_program = $id_kategori_program GROUP BY X.nim;");
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Daftar Mahasiswa Program <?= $kategori_program['nama_kategori'] ?></h4>
                    </div>
                    <div class="card-body">
