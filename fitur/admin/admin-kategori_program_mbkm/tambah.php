                        ...
                        <div class="basic-form">
                            <form role="form" action="" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="jumlah_mahasiswa" placeholder="Jumlah Mahasiswa">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-10 ">
                                        <button type="submit" name="tambah" value="tambah" class="btn btn-primary">Tambah Kategori</button>
                                    </div>
                                </div>
                            </form>
                        </div>
