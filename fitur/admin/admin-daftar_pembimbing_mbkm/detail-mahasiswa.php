                                ...
                                <table class="table table-striped table-responsive-sm">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="./download.php?berkas_persyaratan=<?= $MBKMMhs["berkas_persyaratan"]; ?>"><span class="glyphicon glyphicon-info-sign" title="Lihat Berkas"></span><span> lihat berkas</span></td>
                                        </tr>
                                        <tr>
