                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-sm-10 ">
                                <a href="tambah.php" type="submit" name="tambah" value="tambah" class="btn btn-primary">Tambah Dosen</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($enters as $enter) : ?>
                                        <tr>
                                            ...
                                            <td><a href="ubah.php?id_dosen=<?= $enter["id_dosen"]; ?>"><span class="glyphicon glyphicon-edit" title="Edit Data"></span></a> | <a href="hapus.php?id_dosen=<?= $enter["id_dosen"]; ?>"><span class="glyphicon glyphicon-remove" title="Hapus Data" onclick="return confirm('Yakin?')"></span></a> | <a href="list-mahasiswa.php?id_dosen=<?= $enter["id_dosen"]; ?>"><span class="glyphicon glyphicon-info-sign" title="Detail Mahasiswa"></span><span> Daftar Mahasiswa</span></a></td>
                                        </tr>
                                    <?php endforeach;
                                    ?>
                                </tbody>
